...
<div class="space-y-5 sm:space-y-6">
    ...
    <div class="sm:flex sm:items-center sm:justify-between">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-500">Update your skill information</p>
        </div>
    ...
    <div class="bg-white border border-gray-200 rounded-xl overflow-hidden">
        <form action="{{ route('admin.skills.update', $skill) }}" method="POST" enctype="multipart/form-data" class="p-6 space-y-6">
            @csrf
            @method('PUT')
            <!-- Skill Name -->
            <div class="mb-6">
                <label for="name" class="block text-sm font-semibold text-gray-900 mb-1">Skill Name *</label>
            ...
            <!-- Logo -->
            <div class="mb-6">
                <label for="logo" class="block text-sm font-semibold text-gray-900 mb-1">Skill Logo</label>
                ...
                @if($skill->logo)
                <div class="mt-2">
                    <img src="{{ asset('storage/' . $skill->logo) }}" alt="{{ $skill->name }}" class="h-12 w-12 rounded object-cover border">
                </div>
                @endif
