...
<div class="space-y-5 sm:space-y-6">
    ...
    <div class="sm:flex sm:items-center sm:justify-between">
        <div>
            <h1 class="text-xl font-bold text-gray-900">Edit Brand</h1>
    ...
    <div class="bg-white border border-gray-200 rounded-xl overflow-hidden">
        <form action="{{ route('admin.brands.update', $brand) }}" method="POST" enctype="multipart/form-data" class="p-6 space-y-6">
            ...
            <!-- Brand Name -->
            <div class="mb-6">
                <label for="name" class="block text-sm font-semibold text-gray-900 mb-1">Brand Name *</label>
            ...
            <!-- Logo -->
            <div class="mb-6">
                <label for="logo" class="block text-sm font-semibold text-gray-900 mb-1">Brand Logo</label>
                ...
                @if($brand->logo)
                <div class="mt-2">
                    <img src="{{ asset('storage/' . $brand->logo) }}" alt="{{ $brand->name }}" class="h-12 w-12 rounded object-cover border">
                </div>
                @endif
                <p class="mt-1 text-sm text-gray-500 flex items-center">
                    ...
                    Upload a logo for your brand (optional, max 2MB)
                </p>
                @error('logo')
                <p class="mt-1 text-sm text-red-600 flex items-center">
                    <svg class="w-4 h-4 mr-1 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
